...
A sample workflow is available in the AMALTHEA example projects inside of @org.eclipse.app4mc.amalthea.example.democar.mapping/workflow/sample_workflow.js@. In general this workflow contains all steps as shown in the AMALTHEA examples tutorial "Task creation":../../org.eclipse.app4mc.multicore.help/help/tutorial_create_task.html#example-task-creation and "Mapping example":../../org.eclipse.app4mc.multicore.help/help/tutorial_mapping_1.html#example-mapping-1, but it can be executed in one script. Execute it by doing a right click and then __Run As -> EASE Script__.
...
# Perform the "Create Tasks":#component-create-tasks component
...
# Perform the "Generate Mapping":#component-generate-mapping component with the dfg algorithm on the result of the Create Tasks component. This is done by specifying @modelSlot = "createtasks"@.

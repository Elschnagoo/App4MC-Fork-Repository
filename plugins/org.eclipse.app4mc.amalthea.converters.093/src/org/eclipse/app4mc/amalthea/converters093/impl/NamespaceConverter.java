...
public class NamespaceConverter implements IConverter {
	...
	public void convert(final File targetFile, final Map<File, Document> fileName_documentsMap,
		...
		this.logger.info("Migration from 0.9.2 to 0.9.3 : Executing Namespace converter for model file : "
				+ targetFile.getName());
		...
		this.helper.updateRootElement_NameSpaces_to_093(rootElement);

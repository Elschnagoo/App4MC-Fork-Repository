...
public class HelperUtils_092_093 extends AbstractHelper {

	private HelperUtils_092_093() {

	}

	private static HelperUtils_092_093 instance;

	public static HelperUtils_092_093 getInstance() {

		if (instance == null) {
			instance = new HelperUtils_092_093();
		}
	...
	public void updateRootElement_NameSpaces_to_093(final Element rootElement) {

		final Namespace defaultNamespace = rootElement.getNamespace();


		if (isNS_AvailableIn_092(defaultNamespace)) {
			...
			rootElement.setNamespace(getNS_093("am"));

			// updating additional namespaces to the ones from 0.9.3

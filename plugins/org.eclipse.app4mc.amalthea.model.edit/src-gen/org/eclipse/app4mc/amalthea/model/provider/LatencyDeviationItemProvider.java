...
/**
 * This is the item provider adapter for a {@link org.eclipse.app4mc.amalthea.model.LatencyDeviation} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class LatencyDeviationItemProvider extends AmaltheaExtendedItemProviderAdapter
	 ...
	 * @generated
	 */
	public LatencyDeviationItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AmaltheaPackage.eINSTANCE.getLatencyDeviation_Deviation());
		}
	...
	/**
	 * This returns LatencyDeviation.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LatencyDeviation"));
	}
	...
	public String getTextGen(Object object) {
		RWType labelValue = ((LatencyDeviation)object).getAccessType();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ?
			getString("_UI_LatencyDeviation_type") :
			getString("_UI_LatencyDeviation_type") + " " + label;
	}
	...
	public void notifyChanged(final Notification notification) {
		...
		final List<ViewerNotification> notifications = CustomItemProviderService
				.getLatencyDeviationItemProviderNotifications(notification);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AmaltheaPackage.eINSTANCE.getLatencyDeviation_Deviation(),

...
/**
 * This is the item provider adapter for a {@link org.eclipse.app4mc.amalthea.model.OperatingSystem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperatingSystemItemProvider extends BaseObjectItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AmaltheaPackage.eINSTANCE.getOperatingSystem_Name(),
				 true,
				 false,
				 false,
	...
	protected void addOverheadPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OperatingSystem_overhead_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OperatingSystem_overhead_feature", "_UI_OperatingSystem_type"),
				 AmaltheaPackage.eINSTANCE.getOperatingSystem_Overhead(),
				 true,
				 false,
				 true,
				 null,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AmaltheaPackage.eINSTANCE.getOperatingSystem_TaskSchedulers(),

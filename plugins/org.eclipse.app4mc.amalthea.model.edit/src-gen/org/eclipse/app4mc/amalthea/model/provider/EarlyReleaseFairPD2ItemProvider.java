 ...
 * @generated
 */
public class EarlyReleaseFairPD2ItemProvider extends TaskSchedulingAlgorithmItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EarlyReleaseFairPD2_quantSizeNs_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EarlyReleaseFairPD2_quantSizeNs_feature", "_UI_EarlyReleaseFairPD2_type"),
				 AmaltheaPackage.eINSTANCE.getEarlyReleaseFairPD2_QuantSizeNs(),
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EarlyReleaseFairPD2.class)) {

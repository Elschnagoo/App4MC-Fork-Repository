...
/**
 * This is the item provider adapter for a {@link org.eclipse.app4mc.amalthea.model.Array} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ArrayItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addNumberElementsPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Number Elements feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNumberElementsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Array_numberElements_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Array_numberElements_feature", "_UI_Array_type"),
				 AmaltheaPackage.eINSTANCE.getArray_NumberElements(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AmaltheaPackage.eINSTANCE.getArray_DataType());
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Array_type") + " " + array.getNumberElements();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Array.class)) {
			case AmaltheaPackage.ARRAY__NUMBER_ELEMENTS:
				...
				return;
			case AmaltheaPackage.ARRAY__CUSTOM_PROPERTIES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AmaltheaPackage.eINSTANCE.getArray_DataType(),

...
public class SchedulerItemProvider extends ReferableBaseObjectItemProvider {
	...
	/**
	 * This adds a property descriptor for the Schedule Unit Priority feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addScheduleUnitPriorityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Scheduler_scheduleUnitPriority_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Scheduler_scheduleUnitPriority_feature", "_UI_Scheduler_type"),
				 AmaltheaPackage.eINSTANCE.getScheduler_ScheduleUnitPriority(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AmaltheaPackage.eINSTANCE.getScheduler_SchedulingUnit());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AmaltheaPackage.eINSTANCE.getScheduler_SchedulingUnit(),

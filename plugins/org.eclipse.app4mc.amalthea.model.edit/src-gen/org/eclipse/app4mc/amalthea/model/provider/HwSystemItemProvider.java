...
/**
 * This is the item provider adapter for a {@link org.eclipse.app4mc.amalthea.model.HwSystem} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class HwSystemItemProvider extends ComplexNodeItemProvider {
	/**
	 ...
	 * @generated
	 */
	public HwSystemItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_HwSystem_systemType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_HwSystem_systemType_feature", "_UI_HwSystem_type"),
				 AmaltheaPackage.eINSTANCE.getHwSystem_SystemType(),
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/HwSystem"));
	}
	...
	public String getText(Object object) {
		String label = ((HwSystem)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_HwSystem_type") :
			getString("_UI_HwSystem_type") + " " + label;
	}

...
/**
 * This is the item provider adapter for a {@link org.eclipse.app4mc.amalthea.model.TimeBetaDistribution} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TimeBetaDistributionItemProvider extends BoundedTimeDistributionItemProvider {
	/**
	 ...
	 * @generated
	 */
	public TimeBetaDistributionItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TimeBetaDistribution_alpha_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TimeBetaDistribution_alpha_feature", "_UI_TimeBetaDistribution_type"),
				 AmaltheaPackage.eINSTANCE.getTimeBetaDistribution_Alpha(),
				 true,
				 false,
				 false,
	...
	protected void addBetaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TimeBetaDistribution_beta_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TimeBetaDistribution_beta_feature", "_UI_TimeBetaDistribution_type"),
				 AmaltheaPackage.eINSTANCE.getTimeBetaDistribution_Beta(),
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	/**
	 * This returns TimeBetaDistribution.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/TimeBetaDistribution"));
	}

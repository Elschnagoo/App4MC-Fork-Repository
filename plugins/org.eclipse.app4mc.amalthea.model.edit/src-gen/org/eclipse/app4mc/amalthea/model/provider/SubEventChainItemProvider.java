 ...
 * @generated
 */
public class SubEventChainItemProvider extends EventChainItemItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AmaltheaPackage.eINSTANCE.getSubEventChain_EventChain());
		}
	...
	public String getTextGen(Object object) {
		return getString("_UI_SubEventChain_type");
	}
	...
	public String getText(final Object object) {
		...
		return CustomItemProviderService.getSubEventChainItemProviderText(object, getTextGen(object));
	}
	...
	public void notifyChangedGen(Notification notification) {
		...
		switch (notification.getFeatureID(SubEventChain.class)) {
	...
	public void notifyChanged(final Notification notification) {
		...
		final List<ViewerNotification> notifications = CustomItemProviderService
				.getSubEventChainItemProviderNotifications(notification);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AmaltheaPackage.eINSTANCE.getSubEventChain_EventChain(),

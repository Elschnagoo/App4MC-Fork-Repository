...
/**
 * This is the item provider adapter for a {@link org.eclipse.app4mc.amalthea.model.LatencyAccessPath} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class LatencyAccessPathItemProvider extends AmaltheaExtendedItemProviderAdapter
	 ...
	 * @generated
	 */
	public LatencyAccessPathItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AmaltheaPackage.eINSTANCE.getLatencyAccessPath_Latencies());
		}
	...
	/**
	 * This returns LatencyAccessPath.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LatencyAccessPath"));
	}
	...
	public String getTextGen(Object object) {
		String label = ((LatencyAccessPath)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_LatencyAccessPath_type") :
			getString("_UI_LatencyAccessPath_type") + " " + label;
	}
	...
	public String getText(final Object object) {
		...
		return CustomItemProviderService.getLatencyAccessPathItemProviderText(object, getTextGen(object));
	}
	...
	public void notifyChangedGen(Notification notification) {
		...
		switch (notification.getFeatureID(LatencyAccessPath.class)) {
	...
	public void notifyChanged(final Notification notification) {
		...
		final List<ViewerNotification> notifications = CustomItemProviderService
				.getLatencyAccessPathItemProviderNotifications(notification);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AmaltheaPackage.eINSTANCE.getLatencyAccessPath_Latencies(),

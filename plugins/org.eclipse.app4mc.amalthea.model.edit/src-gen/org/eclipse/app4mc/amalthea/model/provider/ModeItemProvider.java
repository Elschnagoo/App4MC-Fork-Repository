...
public class ModeItemProvider extends ReferableBaseObjectItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AmaltheaPackage.eINSTANCE.getMode_Literals());
		}
	...
	public void notifyChanged(final Notification notification) {
		...
		final List<ViewerNotification> notifications = CustomItemProviderService
				.getModeItemProviderNotifications(notification);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AmaltheaPackage.eINSTANCE.getMode_Literals(),

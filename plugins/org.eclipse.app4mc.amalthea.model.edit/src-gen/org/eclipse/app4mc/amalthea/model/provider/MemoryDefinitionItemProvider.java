...
/**
 * This is the item provider adapter for a {@link org.eclipse.app4mc.amalthea.model.MemoryDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MemoryDefinitionItemProvider extends HwDefinitionItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MemoryDefinitionItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MemoryDefinition_classifiers_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MemoryDefinition_classifiers_feature", "_UI_MemoryDefinition_type"),
				 AmaltheaPackage.eINSTANCE.getMemoryDefinition_Classifiers(),
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns MemoryDefinition.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MemoryDefinition"));
	}
	...
	public String getText(Object object) {
		String label = ((MemoryDefinition)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_MemoryDefinition_type") :
			getString("_UI_MemoryDefinition_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AmaltheaPackage.eINSTANCE.getMemoryDefinition_Size(),

...
/**
 * This is the item provider adapter for a {@link org.eclipse.app4mc.amalthea.model.OsEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OsEventItemProvider extends ReferableBaseObjectItemProvider {
	/**
	...
	/**
	 * This adds a property descriptor for the Communication Overhead In Bit feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addCommunicationOverheadInBitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OsEvent_communicationOverheadInBit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OsEvent_communicationOverheadInBit_feature", "_UI_OsEvent_type"),
				 AmaltheaPackage.eINSTANCE.getOsEvent_CommunicationOverheadInBit(),
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((OsEvent)object).getName();

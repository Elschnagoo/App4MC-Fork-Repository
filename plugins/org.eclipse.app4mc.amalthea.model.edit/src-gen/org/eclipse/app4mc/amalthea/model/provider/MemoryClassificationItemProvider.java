 ...
 * @generated
 */
public class MemoryClassificationItemProvider extends ClassificationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public MemoryClassificationItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_MemoryClassification_classifiers_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_MemoryClassification_classifiers_feature", "_UI_MemoryClassification_type"),
				 AmaltheaPackage.eINSTANCE.getMemoryClassification_Classifiers(),
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns MemoryClassification.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/MemoryClassification"));
	}
	...
	public String getTextGen(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_MemoryClassification_type") :
	...
	public void notifyChanged(final Notification notification) {
		...
		final ViewerNotification vn = CustomItemProviderService
				.getMemoryClassificationItemProviderNotification(notification);
		if (vn != null) {

...
/**
 * This is the item provider adapter for a {@link org.eclipse.app4mc.amalthea.model.ComplexNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComplexNodeItemProvider extends ReferableBaseObjectItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AmaltheaPackage.eINSTANCE.getComplexNode_Components());
			childrenFeatures.add(AmaltheaPackage.eINSTANCE.getComplexNode_Ports());
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AmaltheaPackage.eINSTANCE.getComplexNode_Prescaler(),
				 AmaltheaFactory.eINSTANCE.createPrescaler()));

		newChildDescriptors.add
			(createChildParameter
				(AmaltheaPackage.eINSTANCE.getComplexNode_Memories(),
				 AmaltheaFactory.eINSTANCE.createMemory()));

		newChildDescriptors.add
			(createChildParameter
				(AmaltheaPackage.eINSTANCE.getComplexNode_Networks(),
				 AmaltheaFactory.eINSTANCE.createNetwork()));

		newChildDescriptors.add
			(createChildParameter
				(AmaltheaPackage.eINSTANCE.getComplexNode_Components(),
				 AmaltheaFactory.eINSTANCE.createHwComponent()));

		newChildDescriptors.add
			(createChildParameter
				(AmaltheaPackage.eINSTANCE.getComplexNode_Ports(),

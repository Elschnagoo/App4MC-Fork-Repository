...
/**
 * This is the item provider adapter for a {@link org.eclipse.app4mc.amalthea.model.ComponentInstance} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 *
 * @generated
 */
public class ComponentInstanceItemProvider extends ReferableBaseObjectItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 AmaltheaPackage.eINSTANCE.getComponentInstance_Type(),
				 true,
				 false,
				 true,
				 null,
	...
	public String getText(final Object object) {
		...
		return CustomItemProviderService.getComponentInstanceItemProviderText(object, getTextGen(object));
	}
	...
	public void notifyChanged(final Notification notification) {
		...
		final ViewerNotification vn = CustomItemProviderService
				.getComponentInstanceItemProviderNotification(notification);
		if (vn != null) {

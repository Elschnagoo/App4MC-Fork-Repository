...
/**
 * This is the item provider adapter for a {@link org.eclipse.app4mc.amalthea.model.TypeRef} object.
 * <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * @generated
 */
public class TypeRefItemProvider extends AmaltheaExtendedItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TypeRef_typeDef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TypeRef_typeDef_feature", "_UI_TypeRef_type"),
				 AmaltheaPackage.eINSTANCE.getTypeRef_TypeDef(),
				 true,
				 false,
				 true,
				 null,
	...
	public String getTextGen(Object object) {
		return getString("_UI_TypeRef_type");
	}
	...
	public String getText(final Object object) {
		...
		return CustomItemProviderService.getTypeRefItemProviderText(object, getTextGen(object));
	}
	...
	public void notifyChanged(final Notification notification) {
		...
		final List<ViewerNotification> notifications = CustomItemProviderService
				.getTypeRefItemProviderNotifications(notification);

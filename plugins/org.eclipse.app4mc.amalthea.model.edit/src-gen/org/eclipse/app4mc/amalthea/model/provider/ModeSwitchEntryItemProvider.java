...
public class ModeSwitchEntryItemProvider extends BaseObjectItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ModeSwitchEntry_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ModeSwitchEntry_value_feature", "_UI_ModeSwitchEntry_type"),
				 AmaltheaPackage.eINSTANCE.getModeSwitchEntry_Value(),
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDefaultPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ModeSwitchEntry_default_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ModeSwitchEntry_default_feature", "_UI_ModeSwitchEntry_type"),
				 AmaltheaPackage.eINSTANCE.getModeSwitchEntry_Default(),
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AmaltheaPackage.eINSTANCE.getModeSwitchEntry_GraphEntries());
		}
	...
	public String getTextGen(Object object) {
		ModeSwitchEntry modeSwitchEntry = (ModeSwitchEntry)object;
		return getString("_UI_ModeSwitchEntry_type") + " " + modeSwitchEntry.isDefault();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AmaltheaPackage.eINSTANCE.getModeSwitchEntry_GraphEntries(),

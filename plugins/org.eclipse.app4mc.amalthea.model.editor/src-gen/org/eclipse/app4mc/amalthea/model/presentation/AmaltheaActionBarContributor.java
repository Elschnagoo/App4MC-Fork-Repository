...
/**
 * This is the action bar contributor for the Amalthea model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AmaltheaActionBarContributor
	...
	protected IAction showPropertiesViewAction =
		new Action(AmaltheaEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
			@Override
			public void run() {
				try {
	...
	protected IAction refreshViewerAction =
		new Action(AmaltheaEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
			@Override
	 ...
	 * @generated
	 */
	public AmaltheaActionBarContributor() {
		super(ADDITIONS_LAST_STYLE);
		loadResourceAction = new LoadResourceAction();
		validateAction = new ValidateAction();
		liveValidationAction = new DiagnosticDecorator.LiveValidator.LiveValidationAction(AmaltheaEditorPlugin.getPlugin().getDialogSettings());
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		...
		toolBarManager.add(new Separator("amalthea-settings"));
		toolBarManager.add(new Separator("amalthea-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(AmaltheaEditorPlugin.INSTANCE.getString("_UI_AmaltheaEditor_menu"), "org.eclipse.app4mc.amalthea.modelMenuID");
		...
		//
		createChildMenuManager = new MenuManager(AmaltheaEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(AmaltheaEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(AmaltheaEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		populateManager(submenuManager, createChildSubmenuActions, null);
		populateManager(submenuManager, createChildActions, null);
		menuManager.insertBefore("edit", submenuManager);

		submenuManager = new MenuManager(AmaltheaEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));

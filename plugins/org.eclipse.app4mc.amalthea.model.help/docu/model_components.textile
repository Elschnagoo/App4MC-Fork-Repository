...
The namespace for the model is "http://app4mc.eclipse.org/amalthea/0.7.0/components".
...
The 'FInterfacePort' class contains the attribute 'kind' to set the port direction ('provides' or 'requires'). Additionally it refers the Franca IDL where a detailed description of the interfaces is possible. 
...
The interfaces in Franca can be referenced from AMALTHEA ports.

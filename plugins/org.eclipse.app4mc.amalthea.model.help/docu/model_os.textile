...
h2(#OsDataConsistency). OS Data Consistency

The __OsDataConsistency__ class provides a way to globally configure an automatic data consistency mechanism. It is used to cover the following two use cases:

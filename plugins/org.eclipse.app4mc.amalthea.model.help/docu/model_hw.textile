...
h3. New Hardware Model %{color:red}- **DRAFT !** -%
...
The following Zip archive contains two simple examples.
* "Archive":../help-model/examples/new-hw-example-projects.zip

Save the archive via @"Save target as..."@  
and import it into the workspace via @"Import..." > "Existing Projects into Workspace"@

h4. Class Diagrams

h5. Hardware model elements

!(scale)../pictures/model_hw_main.png!

h5. Hardware definitions and features

!(scale)../pictures/model_hw_definition.png!

h5. Hardware modules and access elements

!(scale)../pictures/model_hw_module.png!

h5. Hardware paths and destinations

...
The reason for doing this is that Tags used in the sub models mostly have a different technical background. It should  be avoided that e.g. elements in the software model are referencing Tags from a components model.

...
A stimulus is responsible to activate processes. The folowing different types are available:
...
* *InterProcess*: Activations based on an explicit inter-process activation*
...
* *PeriodicEvent*: Periodic avtivations based on other events, like rotation speed dependency

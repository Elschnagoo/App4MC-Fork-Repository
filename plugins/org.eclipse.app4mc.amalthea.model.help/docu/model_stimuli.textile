...
*(validation-rule) **%{color:red}[Error]%** _Periodic_: The _Time_ object in the role of _offset_ must not contain a negative value!
*(validation-rule) **%{color:red}[Error]%** _Periodic_: The _Time_ object in the role of _recurrence_ must not contain a negative value!
*(validation-rule) **%{color:red}[Error]%** _Synthetic_: The _Time_ object in the role of _offset_ must not contain a negative value!
*(validation-rule) **%{color:red}[Error]%** _Synthetic_: The _Time_ object in the role of _recurrence_ must not contain a negative value!
*(validation-rule) **%{color:red}[Error]%** _TimestampList_: The _Time_ objects in the role of _timestamps_ must not contain a negative value!
*(validation-rule) **%{color:red}[Error]%** _Single_: The _Time_ object in the role of _activation_ must not contain a negative value!
*(validation-rule) **%{color:red}[Error]%** _ArrivalCurveEntry_: The _Time_ object in the role of _lowerTimeBorder_ must not contain a negative value!
*(validation-rule) **%{color:red}[Error]%** _ArrivalCurveEntry_: The _Time_ object in the role of _upperTimeBorder_ must not contain a negative value!
...
*(validation-rule)  **%{color:red}[Error]%** _ModeValueListEntry_: The _Mode_ objects referenced via _valueProvider_ and _value_ must be equal!
...
*(validation-rule) **%{color:red}[Error]%** _ClockTriangleFunction_: The _Time_ object in the role of _period_ must not contain a negative value!
*(validation-rule) **%{color:red}[Error]%** _ClockSinusFunction_: The _Time_ object in the role of _period_ must not contain a negative value!
*(validation-rule) **%{color:red}[Error]%** _ClockMultiplierListEntry_: The _Time_ object in the role of _time_ must not contain a negative value!

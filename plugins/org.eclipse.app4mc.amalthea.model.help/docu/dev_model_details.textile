...
| @CoreAllocation@ |{color:green}. &#8592; *coreAllocation* |>. *scheduler* &#8594; | @Scheduler@ |
| @Mapping@ |{color:green}. &#8592; *mapping* |>. *memory* &#8594; | @Memory@ |
...
{	...	
	...
	refers readonly transient TaskRunnableCall[] taskRunnableCalls opposite runnableLinkInt 
}
p. 

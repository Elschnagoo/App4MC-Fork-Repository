...
| __dataStability__ | Enumeration value to represent the data stability needs of the label |
...
| __dataStability__ | Describes the data stability needs. It can overwrite or inherit the label setting. |
| __statistic__ | TODO |

...
__Needs__ are used to express execution needs in the most abstract way. The number characterizes the amount of computation that is necessary to execute e.g. a __Runnable__. In future releases __Needs__ will replace __Instructions__ because they can also represent instructions but are more flexible.

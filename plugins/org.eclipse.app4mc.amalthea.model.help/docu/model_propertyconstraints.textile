...
The __MemoryMappingConstraint__ is an abstract class for describing constraints which affect the selection of a suitable __Memory__. The actual constraint on the core is described by the __HwMemoryConstraint__.

...
h3. SectionMappingConstraint

The __SectionMappingConstraint__ is a specialization of the __MappingConstraint__. It is used to specify constraints on __Memory__ elements which are used in Section to __Memory__ mappings.

...
*(validation-rule) _PeriodicActivation_: The _Time_ object in the role of _mim_ must not contain a negative value!
...
| __access__ | <ul><li> *request*: TODO </li><li> *exclusive*: TODO </li><li> *release*: TODO </li></ul> |
| __waitingBehaviour__ | <ul><li> *active*: TODO </li><li> *passive*: TODO </li></ul> |

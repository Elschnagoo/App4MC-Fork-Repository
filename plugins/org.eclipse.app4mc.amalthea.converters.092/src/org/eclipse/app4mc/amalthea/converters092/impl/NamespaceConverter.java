...
package org.eclipse.app4mc.amalthea.converters092.impl;
...
public class NamespaceConverter implements IConverter {
	...
	private final HelperUtils_091_092 helper;
	...
	public void convert(final File targetFile, final Map<File, Document> fileName_documentsMap,
		...
		this.logger.info("Migration from 0.9.1 to 0.9.2 : Executing Namespace converter for model file : "
				+ targetFile.getName());
		...
		this.helper.updateRootElement_NameSpaces_to_092(rootElement);

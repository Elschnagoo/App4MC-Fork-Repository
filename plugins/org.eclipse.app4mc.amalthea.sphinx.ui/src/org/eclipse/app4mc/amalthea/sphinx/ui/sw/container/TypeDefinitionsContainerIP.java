...
public class TypeDefinitionsContainerIP extends ExtendedSphinxTransientItemProvider {

	public TypeDefinitionsContainerIP(final AdapterFactory adapterFactory, final SWModel parent) {
	...
	protected void collectNewChildDescriptors(final Collection<Object> newChildDescriptors, final Object object) {
		...
		newChildDescriptors.add(createChildParameter(myFeature(), myFactory().createBaseTypeDefinition()));
		newChildDescriptors.add(createChildParameter(myFeature(), myFactory().createDataTypeDefinition()));
	}

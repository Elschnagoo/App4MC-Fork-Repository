...
public class ModesContainerIP extends ExtendedSphinxTransientItemProvider {

	public ModesContainerIP(final AdapterFactory adapterFactory, final SWModel parent) {
		super(adapterFactory);
		parent.eAdapters().add(this);
	}

	protected EStructuralFeature myFeature() {
		return AmaltheaPackage.eINSTANCE.getSWModel_Modes();
	}

...
public class ISRsContainerIP extends ExtendedSphinxTransientItemProvider {

	public ISRsContainerIP(final AdapterFactory adapterFactory, final SWModel parent) {
		super(adapterFactory);
		parent.eAdapters().add(this);
	}

	protected EStructuralFeature myFeature() {
		return AmaltheaPackage.eINSTANCE.getSWModel_Isrs();
	}
	...
	protected void collectNewChildDescriptors(final Collection<Object> newChildDescriptors, final Object object) {
		...
		newChildDescriptors.add(createChildParameter(myFeature(), myFactory().createISR()));
	}

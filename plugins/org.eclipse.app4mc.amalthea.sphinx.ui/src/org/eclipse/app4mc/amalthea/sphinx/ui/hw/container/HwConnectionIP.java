...
public class HwConnectionIP extends ExtendedSphinxTransientItemProvider {

	public HwConnectionIP(final AdapterFactory adapterFactory, final HwStructure parent) {
	...
	public String getText(final Object object) {
		// return getString("_UI_DirectConnection_type"); //$NON-NLS-1$

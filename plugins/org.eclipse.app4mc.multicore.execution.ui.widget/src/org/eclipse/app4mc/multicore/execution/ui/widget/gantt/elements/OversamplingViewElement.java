 ...
 */
public class OversamplingViewElement extends ProgressViewElement{

	public OversamplingViewElement(String style, DurationModelElement model) {
		super("status-over",model);
/*

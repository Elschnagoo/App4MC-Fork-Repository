...
public abstract class AbstractConverter implements IConverter {
	...
	/**
	 * - This method is used to migrate the data of Deviation element (and the corresponding sub-element : Distribution)
	 ...
	 * <tr>
	 * <td>Boundaries</td>
	 * <td>DiscreteValueValueBoundaries</td>
	 * </tr>
	 * 
	 * <tr>
	 * <td>UniformDistribution</td>
	 * <td>DiscreteValueValueUniformDistribution</td>
	 * </tr>
	 * 
	 * <tr>
	 * <td>BetaDistribution</td>
	 * <td>DiscreteValueValueBetaDistribution</td>
	 * </tr>
	 * 
	 * <tr>
	 * <td>WeibullEstimators</td>
	 * <td>DiscreteValueWeibullEstimatorsDistribution</td>
	 * </tr>
	 * <tr>
	 * <td>GaussDistribution</td>
	 * <td>DiscreteValueGaussDistribution</td>
	 * </tr>
	 * 
	 * 
	 * 
	...
	public Element migrateDeviationElement_Containing_LongValue(final Element deviationElement,
			final String newElementName, final double ipcValue) {

		final Element tc_executionTicksElement = new Element(newElementName);
		...
		if (deviationElement != null) {
			...
			final Element child = deviationElement.getChild("lowerBound");
			...
			final Element child2 = deviationElement.getChild("upperBound");

			if (child2 != null) {
				final String value = child2.getAttributeValue("value");
		...
		if (distributionTypeTill092 == null) {
			...
			*/
			...
			final String alpha = distributionElement.getAttributeValue("alpha");
			final String beta = distributionElement.getAttributeValue("beta");
			...
			*/
			...
			final String samplingType = distributionElement.getAttributeValue("samplingType");
			...
			*/
			...
			final String mean = this.helper.getValueFromChildElement(distributionElement, "mean", "value");

			final String sd = this.helper.getValueFromChildElement(distributionElement, "sd", "value");
			;
			...
			*/
			...
			final String pRemainPromille = distributionElement.getAttributeValue("pRemainPromille");
		...
		final Attribute value_TypeAttribute = new Attribute("type", distributionTypeFrom093,
				this.helper.getGenericNS("xsi"));
	 ...
	 * <tr>
	 * <td>Boundaries</td>
	 * <td>ContinuousValueBoundaries</td>
	 * </tr>
	 * 
	 * <tr>
	 * <td>UniformDistribution</td>
	 * <td>ContinuousValueUniformDistribution</td>
	 * </tr>
	 * 
	 * <tr>
	 * <td>BetaDistribution</td>
	 * <td>ContinuousValueBetaDistribution</td>
	 * </tr>
	 * 
	 * <tr>
	 * <td>WeibullEstimators</td>
	 * <td>ContinuousValueWeibullEstimatorsDistribution</td>
	 * </tr>
	 * <tr>
	 * <td>GaussDistribution</td>
	 * <td>ContinuousValueGaussDistribution</td>
	 * </tr>
	 * 
	 * 
	 * 
	...
	public Element migrateDeviationElement_Containing_DoubleValue(final Element deviationElement,
	...
	/**
	 * - This method is used to migrate the data of Deviation element (and the corresponding sub-element : Distribution,
	 * both referring to Time as value) into the equivalent semantics as per 0.9.3 <br>
	 * <b>Note:</b><br>
	 * Below are the mappings for ditribution<br>
	 *
	 * <table>
	 ...
	 * <tr>
	 * <td>Boundaries</td>
	 * <td>TimeBoundaries</td>
	 * </tr>
	 * 
	 * <tr>
	 * <td>UniformDistribution</td>
	 * <td>TimeUniformDistribution</td>
	 * </tr>
	 * 
	 * <tr>
	 * <td>BetaDistribution</td>
	 * <td>TimeBetaDistribution</td>
	 * </tr>
	 * 
	 * <tr>
	 * <td>WeibullEstimators</td>
	 * <td>TimeWeibullEstimatorsDistribution</td>
	 * </tr>
	 * <tr>
	 * <td>GaussDistribution</td>
	 * <td>TimeGaussDistribution</td>
	 * </tr>
	 * 
	 * 
	 * 
	...
	public Element migrateDeviationElement_Containing_TimeValue(final Element deviationElement,
			final String newElementName) {
		...
		final Element lowerBoundElement = new Element("lowerBound");
		final Element upperBoundElement = new Element("upperBound");
		...
		if (deviationElement != null) {
			...
			if (child != null) {
				...
				final String unitValue = child.getAttributeValue("unit");
			...
			if (child2 != null) {
				...
				final String unitValue = child2.getAttributeValue("unit");
		...
		if (distributionTypeTill092 == null) {
			...
			*/
			...
			final String mean_unit = this.helper.getValueFromChildElement(distributionElement, "mean", "unit");

			final String sd = this.helper.getValueFromChildElement(distributionElement, "sd", "value");
			;

			final String sd_unit = this.helper.getValueFromChildElement(distributionElement, "sd", "unit");
			;

			if (mean != null) {

				final Element meanElement = new Element("mean");
			...
			if (sd != null) {
				...
				final Element sdElement = new Element("sd");
			...
			*/
			...
			if (mean != null) {
				...
				final Element averageElement = new Element("average");
	...
	protected String getValueAfterApplyingIPC(final String value, final double ipcValue) {

		if (ipcValue != 0) {
			try {
				final Double result = Double.parseDouble(value) / ipcValue;

...
h3. Understanding Check Catalogs
...
The current configuration of the AMALTHEA model validations can be found in the plugin __org.eclipse.app4mc.amalthea.validation__ in the __plugin.xml__.

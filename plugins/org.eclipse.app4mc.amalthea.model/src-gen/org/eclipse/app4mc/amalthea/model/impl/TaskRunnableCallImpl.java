 ...
 *   <li>{@link org.eclipse.app4mc.amalthea.model.impl.TaskRunnableCallImpl#getRunnableLinkInt <em>Runnable Link Int</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TaskRunnableCallImpl extends CallSequenceItemImpl implements TaskRunnableCall {
	...
	public RunEntityCallStatistic getStatistic() {
		if (statistic != null && statistic.eIsProxy()) {
			...
			if (statistic != oldStatistic) {
				...
				NotificationChain msgs = oldStatistic.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AmaltheaPackage.TASK_RUNNABLE_CALL__STATISTIC, null, null);
				if (newStatistic.eInternalContainer() == null) {
					msgs = newStatistic.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AmaltheaPackage.TASK_RUNNABLE_CALL__STATISTIC, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AmaltheaPackage.TASK_RUNNABLE_CALL__STATISTIC, oldStatistic, statistic));
			}
		}
		return statistic;
	}
	...
	public org.eclipse.app4mc.amalthea.model.Runnable getRunnableLinkInt() {
		if (runnableLinkInt != null && runnableLinkInt.eIsProxy()) {
			...
			if (runnableLinkInt != oldRunnableLinkInt) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AmaltheaPackage.TASK_RUNNABLE_CALL__RUNNABLE_LINK_INT, oldRunnableLinkInt, runnableLinkInt));
			}
		}
	...
	public NotificationChain basicSetRunnableLinkInt(org.eclipse.app4mc.amalthea.model.Runnable newRunnableLinkInt, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AmaltheaPackage.TASK_RUNNABLE_CALL__RUNNABLE_LINK_INT, oldRunnableLinkInt, newRunnableLinkInt);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRunnableLinkInt(org.eclipse.app4mc.amalthea.model.Runnable newRunnableLinkInt) {
		if (newRunnableLinkInt != runnableLinkInt) {
			...
			if (runnableLinkInt != null)
				msgs = ((InternalEObject)runnableLinkInt).eInverseRemove(this, AmaltheaPackage.RUNNABLE__TASK_RUNNABLE_CALLS, org.eclipse.app4mc.amalthea.model.Runnable.class, msgs);
			if (newRunnableLinkInt != null)
				msgs = ((InternalEObject)newRunnableLinkInt).eInverseAdd(this, AmaltheaPackage.RUNNABLE__TASK_RUNNABLE_CALLS, org.eclipse.app4mc.amalthea.model.Runnable.class, msgs);
			msgs = basicSetRunnableLinkInt(newRunnableLinkInt, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmaltheaPackage.TASK_RUNNABLE_CALL__RUNNABLE_LINK_INT, newRunnableLinkInt, newRunnableLinkInt));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AmaltheaPackage.TASK_RUNNABLE_CALL__RUNNABLE_LINK_INT:
				if (runnableLinkInt != null)
					msgs = ((InternalEObject)runnableLinkInt).eInverseRemove(this, AmaltheaPackage.RUNNABLE__TASK_RUNNABLE_CALLS, org.eclipse.app4mc.amalthea.model.Runnable.class, msgs);

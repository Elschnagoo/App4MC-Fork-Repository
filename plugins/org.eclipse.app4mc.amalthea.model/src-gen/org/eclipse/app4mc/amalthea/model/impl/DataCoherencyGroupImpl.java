...
public class DataCoherencyGroupImpl extends ReferableBaseObjectImpl implements DataCoherencyGroup {
	 ...
	 * @ordered
	 */
	protected DataCoherencyGroupScope scope;
	 ...
	 * @generated
	 */
	public DataCoherencyGroupScope getScope() {
		if (scope != null && scope.eIsProxy()) {
			InternalEObject oldScope = (InternalEObject)scope;
			scope = (DataCoherencyGroupScope)eResolveProxy(oldScope);
			if (scope != oldScope) {
	 ...
	 * @generated
	 */
	public DataCoherencyGroupScope basicGetScope() {
		return scope;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetScope(DataCoherencyGroupScope newScope, NotificationChain msgs) {
		DataCoherencyGroupScope oldScope = scope;
		scope = newScope;
		if (eNotificationRequired()) {
	 ...
	 * @generated
	 */
	public void setScope(DataCoherencyGroupScope newScope) {
		if (newScope != scope) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case AmaltheaPackage.DATA_COHERENCY_GROUP__LABELS:
				...
				return;
			case AmaltheaPackage.DATA_COHERENCY_GROUP__SCOPE:
				setScope((DataCoherencyGroupScope)newValue);
				return;
			case AmaltheaPackage.DATA_COHERENCY_GROUP__DIRECTION:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			case AmaltheaPackage.DATA_COHERENCY_GROUP__LABELS:
				...
				return;
			case AmaltheaPackage.DATA_COHERENCY_GROUP__SCOPE:
				setScope((DataCoherencyGroupScope)null);
				return;
			case AmaltheaPackage.DATA_COHERENCY_GROUP__DIRECTION:

...
public class SporadicActivationImpl extends ActivationImpl implements SporadicActivation {
	...
	protected EClass eStaticClass() {
		return AmaltheaPackage.eINSTANCE.getSporadicActivation();
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmaltheaPackage.SPORADIC_ACTIVATION__DESCRIPTION, oldDescription, description));
	}

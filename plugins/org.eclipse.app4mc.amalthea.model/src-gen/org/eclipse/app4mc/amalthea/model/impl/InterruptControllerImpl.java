	...
	public InterruptSchedulingAlgorithm getSchedulingAlgorithm() {
		if (schedulingAlgorithm != null && schedulingAlgorithm.eIsProxy()) {
			...
			if (schedulingAlgorithm != oldSchedulingAlgorithm) {
				...
				NotificationChain msgs = oldSchedulingAlgorithm.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AmaltheaPackage.INTERRUPT_CONTROLLER__SCHEDULING_ALGORITHM, null, null);
				if (newSchedulingAlgorithm.eInternalContainer() == null) {
					msgs = newSchedulingAlgorithm.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AmaltheaPackage.INTERRUPT_CONTROLLER__SCHEDULING_ALGORITHM, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AmaltheaPackage.INTERRUPT_CONTROLLER__SCHEDULING_ALGORITHM, oldSchedulingAlgorithm, schedulingAlgorithm));
			}
		}

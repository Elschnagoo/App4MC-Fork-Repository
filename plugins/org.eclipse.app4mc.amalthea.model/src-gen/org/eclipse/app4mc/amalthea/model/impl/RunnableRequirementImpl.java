...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Runnable Requirement</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.app4mc.amalthea.model.impl.RunnableRequirementImpl#getRunnable <em>Runnable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RunnableRequirementImpl extends RequirementImpl implements RunnableRequirement {
	/**
	 ...
	 * @generated
	 */
	protected RunnableRequirementImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AmaltheaPackage.eINSTANCE.getRunnableRequirement();
	}
		...
		if (runnable != null && runnable.eIsProxy()) {
			...
			if (runnable != oldRunnable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AmaltheaPackage.RUNNABLE_REQUIREMENT__RUNNABLE, oldRunnable, runnable));
			}
		}
		return runnable;
	}
	...
	public void setRunnable(org.eclipse.app4mc.amalthea.model.Runnable newRunnable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmaltheaPackage.RUNNABLE_REQUIREMENT__RUNNABLE, oldRunnable, runnable));
	}

...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Port Interface</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.eclipse.app4mc.amalthea.model.AmaltheaPackage#getPortInterface()
 * @model
 * @generated
 */
public enum PortInterface implements Enumerator {
	/**
	...
	/**
	 * The '<em><b>AXI</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #AXI_VALUE
	 * @generated
	...
	/**
	 * The '<em><b>SWR</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #SWR_VALUE
	 * @generated
	 ...
	 * @ordered
	 */
	public static final int FLEXRAY_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int LIN_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int SPI_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int I2C_VALUE = 0;
	 ...
	 * @ordered
	 */
	public static final int APB_VALUE = 0;
	 ...
	 * @generated
	 */
	private static final PortInterface[] VALUES_ARRAY =
		new PortInterface[] {
			_UNDEFINED_,
			CUSTOM,
			CAN,
	...
	/**
	 * A public read-only list of all the '<em><b>Port Interface</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<PortInterface> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Port Interface</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static PortInterface get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			PortInterface result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Port Interface</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static PortInterface getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			PortInterface result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Port Interface</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static PortInterface get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private PortInterface(int value, String name, String literal) {
		this.value = value;
		this.name = name;

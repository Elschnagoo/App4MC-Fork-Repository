 ...
 * @generated
 */
public abstract class RequirementImpl extends BaseObjectImpl implements Requirement {
	/**
	...
	protected EClass eStaticClass() {
		return AmaltheaPackage.eINSTANCE.getRequirement();
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmaltheaPackage.REQUIREMENT__NAME, oldName, name));
	}
	...
	public void setSeverity(Severity newSeverity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmaltheaPackage.REQUIREMENT__SEVERITY, oldSeverity, severity));
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetLimit(RequirementLimit newLimit, NotificationChain msgs) {
		RequirementLimit oldLimit = limit;
		limit = newLimit;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AmaltheaPackage.REQUIREMENT__LIMIT, oldLimit, newLimit);
	...
	public void setLimit(RequirementLimit newLimit) {
		if (newLimit != limit) {
			...
			if (limit != null)
				msgs = ((InternalEObject)limit).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AmaltheaPackage.REQUIREMENT__LIMIT, null, msgs);
			if (newLimit != null)
				msgs = ((InternalEObject)newLimit).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AmaltheaPackage.REQUIREMENT__LIMIT, null, msgs);
			msgs = basicSetLimit(newLimit, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmaltheaPackage.REQUIREMENT__LIMIT, newLimit, newLimit));
	}

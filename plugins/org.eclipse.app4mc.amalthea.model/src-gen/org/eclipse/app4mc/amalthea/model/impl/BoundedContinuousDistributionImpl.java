...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Bounded Continuous Distribution</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.app4mc.amalthea.model.impl.BoundedContinuousDistributionImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link org.eclipse.app4mc.amalthea.model.impl.BoundedContinuousDistributionImpl#getUpperBound <em>Upper Bound</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BoundedContinuousDistributionImpl extends AmaltheaExtendedEObjectImpl implements BoundedContinuousDistribution {
	/**
	 ...
	 * @generated
	 */
	protected BoundedContinuousDistributionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AmaltheaPackage.eINSTANCE.getBoundedContinuousDistribution();
	}
	...
	public void setLowerBound(Double newLowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmaltheaPackage.BOUNDED_CONTINUOUS_DISTRIBUTION__LOWER_BOUND, oldLowerBound, lowerBound));
	}
	...
	public void setUpperBound(Double newUpperBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmaltheaPackage.BOUNDED_CONTINUOUS_DISTRIBUTION__UPPER_BOUND, oldUpperBound, upperBound));
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case AmaltheaPackage.BOUNDED_CONTINUOUS_DISTRIBUTION___GET_AVERAGE:
				return getAverage();
		}
...
} //BoundedContinuousDistributionImpl

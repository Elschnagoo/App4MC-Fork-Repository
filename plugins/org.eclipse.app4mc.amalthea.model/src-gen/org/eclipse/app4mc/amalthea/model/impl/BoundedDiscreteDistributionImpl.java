...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Bounded Discrete Distribution</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.app4mc.amalthea.model.impl.BoundedDiscreteDistributionImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link org.eclipse.app4mc.amalthea.model.impl.BoundedDiscreteDistributionImpl#getUpperBound <em>Upper Bound</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BoundedDiscreteDistributionImpl extends AmaltheaExtendedEObjectImpl implements BoundedDiscreteDistribution {
	/**
	 ...
	 * @generated
	 */
	protected BoundedDiscreteDistributionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AmaltheaPackage.eINSTANCE.getBoundedDiscreteDistribution();
	}
	...
	public void setLowerBound(Long newLowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmaltheaPackage.BOUNDED_DISCRETE_DISTRIBUTION__LOWER_BOUND, oldLowerBound, lowerBound));
	}
	...
	public void setUpperBound(Long newUpperBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmaltheaPackage.BOUNDED_DISCRETE_DISTRIBUTION__UPPER_BOUND, oldUpperBound, upperBound));
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case AmaltheaPackage.BOUNDED_DISCRETE_DISTRIBUTION___GET_AVERAGE:
				return getAverage();
		}
...
} //BoundedDiscreteDistributionImpl

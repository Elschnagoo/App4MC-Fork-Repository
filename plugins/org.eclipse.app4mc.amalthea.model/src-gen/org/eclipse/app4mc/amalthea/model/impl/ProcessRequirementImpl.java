 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.app4mc.amalthea.model.impl.ProcessRequirementImpl#getProcess <em>Process</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProcessRequirementImpl extends RequirementImpl implements ProcessRequirement {
		...
		if (process != null && process.eIsProxy()) {
			...
			if (process != oldProcess) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AmaltheaPackage.PROCESS_REQUIREMENT__PROCESS, oldProcess, process));
			}
		}
		return process;
	}
	...
	public void setProcess(AbstractProcess newProcess) {
		...
		process = newProcess;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmaltheaPackage.PROCESS_REQUIREMENT__PROCESS, oldProcess, process));
	}

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Runnable Allocation Constraint</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.app4mc.amalthea.model.impl.RunnableAllocationConstraintImpl#getRunnable <em>Runnable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RunnableAllocationConstraintImpl extends CoreAllocationConstraintImpl implements RunnableAllocationConstraint {
	 ...
	 * @generated
	 */
	protected RunnableAllocationConstraintImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AmaltheaPackage.eINSTANCE.getRunnableAllocationConstraint();
	}
		...
		if (runnable != null && runnable.eIsProxy()) {
			...
			if (runnable != oldRunnable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AmaltheaPackage.RUNNABLE_ALLOCATION_CONSTRAINT__RUNNABLE, oldRunnable, runnable));
			}
		}
		return runnable;
	}
	...
	public void setRunnable(org.eclipse.app4mc.amalthea.model.Runnable newRunnable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmaltheaPackage.RUNNABLE_ALLOCATION_CONSTRAINT__RUNNABLE, oldRunnable, runnable));
	}
...
} //RunnableAllocationConstraintImpl

 ...
 *   <li>{@link org.eclipse.app4mc.amalthea.model.impl.MemoryImpl#getMapping <em>Mapping</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MemoryImpl extends ComplexNodeImpl implements Memory {
	...
	public Mapping getMapping() {
		if (mapping != null && mapping.eIsProxy()) {
			...
			if (mapping != oldMapping) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AmaltheaPackage.MEMORY__MAPPING, oldMapping, mapping));
			}
		}
		return mapping;
	}
	...
	public NotificationChain basicSetMapping(Mapping newMapping, NotificationChain msgs) {
		...
		mapping = newMapping;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AmaltheaPackage.MEMORY__MAPPING, oldMapping, newMapping);

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Discrete Value Interval</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.app4mc.amalthea.model.impl.DiscreteValueIntervalImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link org.eclipse.app4mc.amalthea.model.impl.DiscreteValueIntervalImpl#getUpperBound <em>Upper Bound</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DiscreteValueIntervalImpl extends AmaltheaExtendedEObjectImpl implements DiscreteValueInterval {
	/**
	 ...
	 * @generated
	 */
	protected DiscreteValueIntervalImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AmaltheaPackage.eINSTANCE.getDiscreteValueInterval();
	}
	...
	public void setLowerBound(Long newLowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmaltheaPackage.DISCRETE_VALUE_INTERVAL__LOWER_BOUND, oldLowerBound, lowerBound));
	}
	...
	public void setUpperBound(Long newUpperBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmaltheaPackage.DISCRETE_VALUE_INTERVAL__UPPER_BOUND, oldUpperBound, upperBound));
	}

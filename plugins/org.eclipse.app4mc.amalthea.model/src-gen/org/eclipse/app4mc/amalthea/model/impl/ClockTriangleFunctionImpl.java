	...
	public SignedTime getShift() {
		if (shift != null && shift.eIsProxy()) {
			...
			if (shift != oldShift) {
				...
				NotificationChain msgs = oldShift.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AmaltheaPackage.CLOCK_TRIANGLE_FUNCTION__SHIFT, null, null);
				if (newShift.eInternalContainer() == null) {
					msgs = newShift.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AmaltheaPackage.CLOCK_TRIANGLE_FUNCTION__SHIFT, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AmaltheaPackage.CLOCK_TRIANGLE_FUNCTION__SHIFT, oldShift, shift));
			}
		}
		return shift;
	}
	...
	public Time getPeriod() {
		if (period != null && period.eIsProxy()) {
			...
			if (period != oldPeriod) {
				...
				NotificationChain msgs = oldPeriod.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AmaltheaPackage.CLOCK_TRIANGLE_FUNCTION__PERIOD, null, null);
				if (newPeriod.eInternalContainer() == null) {
					msgs = newPeriod.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AmaltheaPackage.CLOCK_TRIANGLE_FUNCTION__PERIOD, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AmaltheaPackage.CLOCK_TRIANGLE_FUNCTION__PERIOD, oldPeriod, period));
			}
		}
		return period;
	}

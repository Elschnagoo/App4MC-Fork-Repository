...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Continuous Weibull Estimators Distribution</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.app4mc.amalthea.model.impl.ContinuousWeibullEstimatorsDistributionImpl#getAverage <em>Average</em>}</li>
 *   <li>{@link org.eclipse.app4mc.amalthea.model.impl.ContinuousWeibullEstimatorsDistributionImpl#getPRemainPromille <em>PRemain Promille</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContinuousWeibullEstimatorsDistributionImpl extends ContinuousWeibullDistributionImpl implements ContinuousWeibullEstimatorsDistribution {
	/**
	 ...
	 * @generated
	 */
	protected ContinuousWeibullEstimatorsDistributionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AmaltheaPackage.eINSTANCE.getContinuousWeibullEstimatorsDistribution();
	}
	...
	public void setAverage(Double newAverage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmaltheaPackage.CONTINUOUS_WEIBULL_ESTIMATORS_DISTRIBUTION__AVERAGE, oldAverage, average));
	}
	...
	public void setPRemainPromille(double newPRemainPromille) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmaltheaPackage.CONTINUOUS_WEIBULL_ESTIMATORS_DISTRIBUTION__PREMAIN_PROMILLE, oldPRemainPromille, pRemainPromille));
	}
...
} //ContinuousWeibullEstimatorsDistributionImpl

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Truncated Continuous Value Distribution</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.app4mc.amalthea.model.impl.TruncatedContinuousValueDistributionImpl#getLowerBound <em>Lower Bound</em>}</li>
 *   <li>{@link org.eclipse.app4mc.amalthea.model.impl.TruncatedContinuousValueDistributionImpl#getUpperBound <em>Upper Bound</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TruncatedContinuousValueDistributionImpl extends AmaltheaExtendedEObjectImpl implements TruncatedContinuousValueDistribution {
	/**
	 ...
	 * @generated
	 */
	protected TruncatedContinuousValueDistributionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AmaltheaPackage.eINSTANCE.getTruncatedContinuousValueDistribution();
	}
	...
	public void setLowerBound(Double newLowerBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmaltheaPackage.TRUNCATED_CONTINUOUS_VALUE_DISTRIBUTION__LOWER_BOUND, oldLowerBound, lowerBound));
	}
	...
	public void setUpperBound(Double newUpperBound) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AmaltheaPackage.TRUNCATED_CONTINUOUS_VALUE_DISTRIBUTION__UPPER_BOUND, oldUpperBound, upperBound));
	}
...
} //TruncatedContinuousValueDistributionImpl

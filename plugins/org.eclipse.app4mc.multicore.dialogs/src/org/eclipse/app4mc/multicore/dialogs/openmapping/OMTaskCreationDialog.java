...
public class OMTaskCreationDialog extends AbstractDialogPage {
	/**
	 * Logging group
	 */
	public final static int TASK_CREATION_GROUP = 0;
	/**
	 * Max group
	 */
	 ...
	 *            preferences store
	 */
	public OMTaskCreationDialog(final IPreferenceStore store) {
		super(store);
	}
	...
	public void createControl(final Composite parent) {
		...
		// Logging group
		this.groups[TASK_CREATION_GROUP] = new OMTaskCreationGroup(parent, this.store);

...
public class OMTask {
	...
	/**
	 * Fetches the referenced stimuli and sets the recursion factor, i.e. how
	 * often this task is being executed DEPRECATED: This method is deprecated.
	 * The overall concept of using a recursion factor should be replaced by a
	 * more accurate and/or efficient approach.
	 *
	 * @return
	 */
	// @Deprecated

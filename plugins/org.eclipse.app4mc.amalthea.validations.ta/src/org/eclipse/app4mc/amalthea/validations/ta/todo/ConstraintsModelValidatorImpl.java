				...
				if(TimeMetric.RESPONSE_TIME == metric) {
					...
					if(null != time) {
						...
						if((0 >= value.signum()) || (TimeUnit._UNDEFINED_ == unit)) {
							issue(timeRequirementLimit, AmaltheaPackage.eINSTANCE.getTimeRequirementLimit_LimitValue(), value);
						}
					}
				}
			}
		...
		while (amaIter.hasNext()) {
			...
			if (elem instanceof SynchronizationConstraint) {
				...
				if(null != tolerance) {
					...
					if(0 > value.signum()) {
						issue(tolerance, AmaltheaPackage.eINSTANCE.getSynchronizationConstraint_Tolerance(), value);
					}
				}
			}
		}
		...
		while (amaIter.hasNext()) {
			...
			if (elem instanceof DelayConstraint) {
				...
				if(null != upper) {
					...
					if(0 > value.signum()) {
						issue(upper, AmaltheaPackage.eINSTANCE.getDelayConstraint_Upper(), value);
					}
				}
			}
		}
		...
		while (amaIter.hasNext()) {
			...
			if (elem instanceof DelayConstraint) {
				...
				if(null != lower) {
					...
					if(0 > value.signum()) {
						issue(lower, AmaltheaPackage.eINSTANCE.getDelayConstraint_Lower(), value);
					}
				}
			}
		}
		...
		while (amaIter.hasNext()) {
			...
			if (elem instanceof EventChainLatencyConstraint) {
				...
				if(null != minimum) {
					...
					if(0 > value.signum()) {
						issue(minimum, AmaltheaPackage.eINSTANCE.getEventChainLatencyConstraint_Minimum(), value);
					}
				}
			}
		}
		...
		while (amaIter.hasNext()) {
			...
			if (elem instanceof EventChainLatencyConstraint) {
				...
				if(null != maximum) {
					...
					if(0 > value.signum()) {
						issue(maximum, AmaltheaPackage.eINSTANCE.getEventChainLatencyConstraint_Maximum(), value);
					}
				}
			}
		}
		...
		while (amaIter.hasNext()) {
			...
			if (elem instanceof RepetitionConstraint) {
				...
				if(null != lower) {
					BigInteger value = lower.getValue();
					if(0 > value.signum()) {
						issue(lower, AmaltheaPackage.eINSTANCE.getRepetitionConstraint_Lower(), value);
					}
				}
			}
		}
		...
		while (amaIter.hasNext()) {
			...
			if (elem instanceof RepetitionConstraint) {
				...
				if(null != upper) {
					BigInteger value = upper.getValue();
					if(0 > value.signum()) {
						issue(upper, AmaltheaPackage.eINSTANCE.getRepetitionConstraint_Upper(), value);
					}
				}
			}
		}
		...
		while (amaIter.hasNext()) {
			...
			if (elem instanceof RepetitionConstraint) {
				...
				if(null != jitter) {
					...
					if(0 > value.signum()) {
						issue(jitter, AmaltheaPackage.eINSTANCE.getRepetitionConstraint_Jitter(), value);
					}
				}
			}
		}
		...
		while (amaIter.hasNext()) {
			...
			if (elem instanceof RepetitionConstraint) {
				...
				if(null != period) {
					...
					if(0 > value.signum()) {
						issue(period, AmaltheaPackage.eINSTANCE.getRepetitionConstraint_Period(), value);
					}
				}
			}
		}
		...
		while (amaIter.hasNext()) {
			...
			if (elem instanceof DataAgeTime) {
				...
				if(null != minimum) {
					BigInteger value = minimum.getValue();
					if(0 > value.signum()) {
						issue(minimum, AmaltheaPackage.eINSTANCE.getDataAgeTime_MinimumTime(), value);
					}
				}
			}
		}
		...
		while (amaIter.hasNext()) {
			...
			if (elem instanceof DataAgeTime) {
				...
				if(null != maximum) {
					BigInteger value = maximum.getValue();
					if(0 > value.signum()) {
						issue(maximum, AmaltheaPackage.eINSTANCE.getDataAgeTime_MaximumTime(), value);
					}
				}
			}
		}

...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Autosar Os Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.app4mc.tracing.converter.ot1.OT1.impl.AutosarOsTypeImpl#getKernelPriority <em>Kernel Priority</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AutosarOsTypeImpl extends SchedulingEntityTypeImpl implements AutosarOsType {
	/**
	...
	protected EClass eStaticClass() {
		return OT1Package.Literals.AUTOSAR_OS_TYPE;
	}
	...
	public void setKernelPriority(long newKernelPriority) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OT1Package.AUTOSAR_OS_TYPE__KERNEL_PRIORITY, oldKernelPriority, kernelPriority, !oldKernelPriorityESet));
	}
	...
	public void unsetKernelPriority() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, OT1Package.AUTOSAR_OS_TYPE__KERNEL_PRIORITY, oldKernelPriority, KERNEL_PRIORITY_EDEFAULT, oldKernelPriorityESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OT1Package.AUTOSAR_OS_TYPE__KERNEL_PRIORITY:

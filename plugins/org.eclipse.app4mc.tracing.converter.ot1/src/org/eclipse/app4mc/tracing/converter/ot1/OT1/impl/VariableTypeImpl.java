 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.app4mc.tracing.converter.ot1.OT1.impl.VariableTypeImpl#getLength <em>Length</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableTypeImpl extends DataElementTypeImpl implements VariableType {
	...
	public void setLength(BigInteger newLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OT1Package.VARIABLE_TYPE__LENGTH, oldLength, length));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OT1Package.VARIABLE_TYPE__LENGTH:
				return getLength();
		}

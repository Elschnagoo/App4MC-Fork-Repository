...
# Following class names are changed <br/><br/> !(#gray_scale)../pictures/class_name_changes_itea1.1.0_0.7.0.png! <br/><br/>

table(#classic){margin-left:40px}. 
|{color:red}. **TODO** | **Replace image above** |
| use table instead | _will be more useful if copy&paste is required_ |

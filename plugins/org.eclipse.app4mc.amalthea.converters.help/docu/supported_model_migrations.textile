...
Below were the releases of AMALTHEA metamodel during its phase of being as a ITEA2 funded project ( For details refer : "www.amalthea-project.org":http://www.amalthea-project.org/index.php/roadmap )

* 1.0.3
* 1.1.0
* 1.1.1

From below version, AMALTHEA metamodel is a part of the official  project Eclipse APP4MC ( See: "www.eclipse.org/app4mc":https://www.eclipse.org/app4mc )

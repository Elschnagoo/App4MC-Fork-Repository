...
|SignedTimeObject|SW Model|Equivalent of this element is TimeObject (which extends Time) in APP4MC 0.8.0. There is no change in the storage format.|
|SignedTime|SW Model|Equivalent of this element is Time in APP4MC 0.8.0. There is no change in the storage format.|
|AbstractTime|SW Model|Time class is equivalent of this model element in APP4MC 0.8.0. There is no change in the storage format.|

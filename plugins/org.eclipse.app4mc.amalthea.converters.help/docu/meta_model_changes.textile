...
|GraphEntryBase| Equivalent element is CallGraph in 0.9.5|
|RunnableItem| Equivalent element is CallGraph in 0.9.5|
...
|Scenario|stimuli|recurrence reference type is changed to counter for VariableRateStimulus|

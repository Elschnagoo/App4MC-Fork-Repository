...
public class RunnableConverterTest extends AbstractConverterTest {
	...
	public static Collection<Object[]> getTestData() {
		...
		return Arrays.asList(new Object[][] {
			{ "/swModel/runnable-deadline/runnable.amxmi", true },
			{ "/swModel/runnable-deadline/runnable2.amxmi", true }
		});
	}

	public RunnableConverterTest(final String xmlFileRelativeLocation, final boolean canExecuteTestCase) {

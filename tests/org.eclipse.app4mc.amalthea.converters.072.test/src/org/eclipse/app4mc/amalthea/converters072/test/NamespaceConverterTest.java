...
public class NamespaceConverterTest extends AbstractConverterTest {
	...
	public static Collection<Object[]> getTestData() {
		...
		return Arrays.asList(new Object[][] { { "/namespace/AMALTHEA_Democar.amxmi", true } });
	}
	...
	public void testConversion() {
		super.testConversion(NamespaceConverter.class, CommonElementsConverter.class, SwConverter.class);
	}

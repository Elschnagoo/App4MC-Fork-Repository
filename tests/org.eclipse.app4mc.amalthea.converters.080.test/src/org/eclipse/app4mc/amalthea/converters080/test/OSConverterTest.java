...
import org.eclipse.app4mc.amalthea.converters080.impl.OSConverter;
...
public class OSConverterTest extends AbstractConverterTest {
	...
	public static Collection<Object[]> getTestData() {
		...
		final String[] inputFiles = new String[] { "/osmodel/osmodel.amxmi" };


		return Arrays.asList(new Object[][] {
				{ "Models with OS Model", true, inputFiles, "Migration of Amalthea models containing OS Model " } });
	}

	public OSConverterTest(final String testDataID, final boolean canExecuteTestCase, final String[] xmlFiles,
	...
	public void testConversion() {
		super.testConversion(org.eclipse.app4mc.amalthea.converters080.impl.NamespaceConverter.class,
				RootElementConverter.class, SwConverter.class, PropertyConstraintsConverter.class, OSConverter.class);
	}
	...
	protected void modelFileVerificationHook(final Document document) {
		...
		xpathBuffer.append("./osModel/osDataConsistency");
		...
		assertTrue("Model migration of \"OS Model\" element is not successful in model file : " + document.getBaseURI(),
				elements.size() == 0);

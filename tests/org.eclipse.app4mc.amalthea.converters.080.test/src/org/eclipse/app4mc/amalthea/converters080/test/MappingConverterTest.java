...
import org.eclipse.app4mc.amalthea.converters080.impl.MappingConverter;
...
public class MappingConverterTest extends AbstractConverterTest {
	...
	public static Collection<Object[]> getTestData() {
		...
		final String[] inputFiles_swModeLabels = new String[] { "/mapping/mapping.amxmi" };


		return Arrays.asList(new Object[][] { { "ModeLabel", true, inputFiles_swModeLabels,
				"Migration of Amalthea models containing AbstractElementMapping" } });
	}

	public MappingConverterTest(final String testDataID, final boolean canExecuteTestCase, final String[] xmlFiles,
	...
	public void testConversion() {
		super.testConversion(org.eclipse.app4mc.amalthea.converters080.impl.NamespaceConverter.class,
				RootElementConverter.class, SwConverter.class, MappingConverter.class);

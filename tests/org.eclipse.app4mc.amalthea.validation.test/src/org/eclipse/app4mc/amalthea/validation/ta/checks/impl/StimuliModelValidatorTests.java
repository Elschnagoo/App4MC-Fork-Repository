...
public class StimuliModelValidatorTests {
	...
	/**
	 * Test for validation method {@link StimuliModelValidator#checkStimulusDeviationUnsigned(AMALTHEA)}
	 */
	@Test
	public void test_checkStimulusDeviationUnsigned_upperBoundNull() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		final Single single = AmaltheaFactory.eINSTANCE.createSingle();
		Deviation<Time> deviation = AmaltheaFactory.eINSTANCE.createDeviation();
		final Time upperBound = null;
		
		amalthea.setStimuliModel(stimuliModel);
		stimuliModel.getStimuli().add(single);
		single.setStimulusDeviation(deviation);
		deviation.setUpperBound(upperBound);
		
		EasyMock.replay(this.issueCreator);

		// test
		this.classUnderTest.checkStimulusDeviationUnsigned(amalthea);
	...
	/**
	 * Test for validation method {@link StimuliModelValidator#checkTimeRequirementLimitLimitUnsigned(AMALTHEA)}
	 */
	@Test
	public void test_checkStimulusDeviationUnsigned_upperBoundNegative() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		final Single single = AmaltheaFactory.eINSTANCE.createSingle();
		Deviation<Time> deviation = AmaltheaFactory.eINSTANCE.createDeviation();
		final Time upperBound = AmaltheaFactory.eINSTANCE.createTime();
	 ...
	 */
	@Test
	public void test_checkStimulusDeviationUnsigned_upperBoundZero() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		final Single single = AmaltheaFactory.eINSTANCE.createSingle();
	 ...
	 */
	@Test
	public void test_checkStimulusDeviationUnsigned_upperBoundPositive() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		final Single single = AmaltheaFactory.eINSTANCE.createSingle();
	 ...
	 */
	@Test
	public void test_checkStimulusDeviationUnsigned_lowerBoundNull() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		final Single single = AmaltheaFactory.eINSTANCE.createSingle();
		Deviation<Time> deviation = AmaltheaFactory.eINSTANCE.createDeviation();
		final Time lowerBound = null;
	 ...
	 */
	@Test
	public void test_checkStimulusDeviationUnsigned_lowerBoundNegative() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		final Single single = AmaltheaFactory.eINSTANCE.createSingle();
		Deviation<Time> deviation = AmaltheaFactory.eINSTANCE.createDeviation();
		final Time lowerBound = AmaltheaFactory.eINSTANCE.createTime();
		final Integer value = -10;
		final TimeUnit unit = TimeUnit.MS;
	 ...
	 */
	@Test
	public void test_checkStimulusDeviationUnsigned_lowerBoundZero() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		final Single single = AmaltheaFactory.eINSTANCE.createSingle();
	 ...
	 */
	@Test
	public void test_checkStimulusDeviationUnsigned_lowerBoundPositive() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		final Single single = AmaltheaFactory.eINSTANCE.createSingle();
	 ...
	 */
	@Test
	public void test_checkStimulusDeviationUnsigned_weibullMeanNull() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		final Single single = AmaltheaFactory.eINSTANCE.createSingle();
		Deviation<Time> deviation = AmaltheaFactory.eINSTANCE.createDeviation();
		WeibullEstimators<Time> weibull = AmaltheaFactory.eINSTANCE.createWeibullEstimators();
		final Time mean = null;
		
		amalthea.setStimuliModel(stimuliModel);
		stimuliModel.getStimuli().add(single);
		single.setStimulusDeviation(deviation);
		deviation.setDistribution(weibull);
	 ...
	 */
	@Test
	public void test_checkStimulusDeviationUnsigned_weibullMeanNegative() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		final Single single = AmaltheaFactory.eINSTANCE.createSingle();
		Deviation<Time> deviation = AmaltheaFactory.eINSTANCE.createDeviation();
		WeibullEstimators<Time> weibull = AmaltheaFactory.eINSTANCE.createWeibullEstimators();
		final Time mean = AmaltheaFactory.eINSTANCE.createTime();
		final Integer value = -10;
		final TimeUnit unit = TimeUnit.MS;
	 ...
	 */
	@Test
	public void test_checkStimulusDeviationUnsigned_weibullMeanZero() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		final Single single = AmaltheaFactory.eINSTANCE.createSingle();
	 ...
	 */
	@Test
	public void test_checkStimulusDeviationUnsigned_weibullMeanPositive() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		final Single single = AmaltheaFactory.eINSTANCE.createSingle();
	 ...
	 */
	@Test
	public void test_checkStimulusDeviationUnsigned_gaussMeanNull() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		final Single single = AmaltheaFactory.eINSTANCE.createSingle();
		Deviation<Time> deviation = AmaltheaFactory.eINSTANCE.createDeviation();
		GaussDistribution<Time> gauss = AmaltheaFactory.eINSTANCE.createGaussDistribution();
		final Time mean = null;
		
		amalthea.setStimuliModel(stimuliModel);
		stimuliModel.getStimuli().add(single);
		single.setStimulusDeviation(deviation);
		deviation.setDistribution(gauss);
		gauss.setMean(mean);
	 ...
	 */
	@Test
	public void test_checkStimulusDeviationUnsigned_gaussMeanNegative() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		final Single single = AmaltheaFactory.eINSTANCE.createSingle();
	 ...
	 */
	@Test
	public void test_checkStimulusDeviationUnsigned_gausslMeanZero() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		final Single single = AmaltheaFactory.eINSTANCE.createSingle();
	 ...
	 */
	@Test
	public void test_checkStimulusDeviationUnsigned_gaussMeanPositive() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		final Single single = AmaltheaFactory.eINSTANCE.createSingle();
	 ...
	 */
	@Test
	public void test_checkStimulusDeviationUnsigned_gaussSdNull() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		final Single single = AmaltheaFactory.eINSTANCE.createSingle();
	 ...
	 */
	@Test
	public void test_checkStimulusDeviationUnsigned_gaussSdNegative() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		final Single single = AmaltheaFactory.eINSTANCE.createSingle();
		Deviation<Time> deviation = AmaltheaFactory.eINSTANCE.createDeviation();
		GaussDistribution<Time> gauss = AmaltheaFactory.eINSTANCE.createGaussDistribution();
		final Time sd = AmaltheaFactory.eINSTANCE.createTime();
		final Integer value = -10;
		final TimeUnit unit = TimeUnit.MS;
	 ...
	 */
	@Test
	public void test_checkStimulusDeviationUnsigned_gaussSdZero() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		final Single single = AmaltheaFactory.eINSTANCE.createSingle();
	 ...
	 */
	@Test
	public void test_checkStimulusDeviationUnsigned_gaussSdPositive() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		final Single single = AmaltheaFactory.eINSTANCE.createSingle();
	...
	/**
	 * Test for validation method {@link StimuliModelValidator#checkClockTriangleFunctionShiftUnsigned(AMALTHEA)}
	 */
	@Test
	public void test_checkClockTriangleFunctionShiftUnsigned_null() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		...
		clockTriangleFunction.setShift(shift);
		
		EasyMock.replay(this.issueCreator);

		// test
		this.classUnderTest.checkClockTriangleFunctionShiftUnsigned(amalthea);
	 ...
	 */
	@Test
	public void test_checkClockTriangleFunctionShiftUnsigned_negative() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		ClockTriangleFunction clockTriangleFunction = AmaltheaFactory.eINSTANCE.createClockTriangleFunction();
		final Time shift = AmaltheaFactory.eINSTANCE.createTime();
		final Integer value = -10;
		final TimeUnit unit = TimeUnit.MS;
	 ...
	 */
	@Test
	public void test_checkClockTriangleFunctionShiftUnsigned_zero() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		ClockTriangleFunction clockTriangleFunction = AmaltheaFactory.eINSTANCE.createClockTriangleFunction();
	 ...
	 */
	@Test
	public void test_checkClockTriangleFunctionShiftUnsigned_positive() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		ClockTriangleFunction clockTriangleFunction = AmaltheaFactory.eINSTANCE.createClockTriangleFunction();
	...
	/**
	 * Test for validation method {@link StimuliModelValidator#checkClockSinusFunctionShiftUnsigned(AMALTHEA)}
	 */
	@Test
	public void test_checkClockSinusFunctionShiftUnsigned_null() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		...
		clockSinusFunction.setShift(shift);
		
		EasyMock.replay(this.issueCreator);

		// test
		this.classUnderTest.checkClockSinusFunctionShiftUnsigned(amalthea);
	 ...
	 */
	@Test
	public void test_checkClockSinusFunctionShiftUnsigned_negative() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		ClockSinusFunction clockSinusFunction = AmaltheaFactory.eINSTANCE.createClockSinusFunction();
	 ...
	 */
	@Test
	public void test_checkClockSinusFunctionShiftUnsigned_zero() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		ClockSinusFunction clockSinusFunction = AmaltheaFactory.eINSTANCE.createClockSinusFunction();
	 ...
	 */
	@Test
	public void test_checkClockSinusFunctionShiftUnsigned_positive() {
		// prepare
		final Amalthea amalthea = AmaltheaFactory.eINSTANCE.createAmalthea();
		final StimuliModel stimuliModel = AmaltheaFactory.eINSTANCE.createStimuliModel();
		ClockSinusFunction clockSinusFunction = AmaltheaFactory.eINSTANCE.createClockSinusFunction();

...
import org.eclipse.app4mc.amalthea.converters110.impl.CentralConverter;
...
public class CentralConverterTest extends AbstractConverterTest {
	...
	public static Collection<Object[]> getTestData() {
		...
		return Arrays.asList(new Object[][] { { "/central/central.amxmi", true } });
	}

	public CentralConverterTest(final String xmlFileRelativeLocation, final boolean canExecuteTestCase) {
